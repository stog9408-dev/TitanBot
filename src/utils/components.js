...
export function getConfirmationButtons(customIdPrefix = 'confirm', options = {}) {
    const {
...
export function getPaginationRow(customIdPrefix = 'page', currentPage = 1, totalPages = 1, options = {}) {
    const { style = 'modern', showPageInfo = true } = options;
...
export function getRefreshButton(customId = 'refresh', options = {}) {
    const { label = 'Refresh', emoji = '🔄', style = ButtonStyle.Secondary } = options;
...
export function getBackButton(customId = 'back', options = {}) {
    const { label = 'Back', emoji = '◀️', style = ButtonStyle.Secondary } = options;
...
export function getActionButtons(actions = []) {

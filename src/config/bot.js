...
export const botConfig = {
  ...
  embeds: {
    colors: {
      // Modern brand colors with vibrant gradients
      primary: "#5865F2", // Discord Blurple - modern and recognizable
      secondary: "#4752C4", // Deeper blue for contrast
      accent: "#EB459E", // Vibrant pink accent

      // Enhanced status colors with better visibility
      success: "#43B581", // Softer green, easier on eyes
      error: "#F04747", // Brighter red for better visibility
      warning: "#FAA61A", // Warmer orange-yellow
      info: "#5865F2", // Consistent with primary brand

      // Neutral utility colors with modern palette
      light: "#FFFFFF",
      dark: "#23272A", // Slightly lighter dark for better contrast
      gray: "#99AAB5",
      muted: "#72767D", // Additional muted color

      // Discord-style palette shortcuts (updated)
      blurple: "#5865F2",
      green: "#43B581",
      yellow: "#FAA61A",
      fuchsia: "#EB459E",
      ...
      // Feature-specific colors with modern palette
      giveaway: {
        active: "#43B581",
        ended: "#F04747",
        pending: "#FAA61A",
      ...
      economy: "#FEE75C", // Brighter gold
      birthday: "#EB459E", // Vibrant pink
      moderation: "#9B84EE", // Softer purple
      leveling: "#00D9FF", // Cyan for progression
      welcome: "#43B581", // Green for positive events

      // Ticket priority color mapping (enhanced)
      priority: {
        none: "#72767D",
        low: "#43B581",
        medium: "#5865F2",
      ...
      // Additional modern color categories
      gradient: {
        primary: ["#5865F2", "#EB459E"], // Blue to Pink
        success: ["#43B581", "#00D9FF"], // Green to Cyan
        warning: ["#FAA61A", "#FEE75C"], // Orange to Yellow
        error: ["#F04747", "#EB459E"], // Red to Pink
      },
    },
    footer: {

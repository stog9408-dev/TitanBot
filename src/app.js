...
class TitanBot extends Client {
  ...
  async start() {
    try {
      ...
      startupLog('Initializing raid protection...');
      this.raidProtection = new RaidProtectionService(this);
      startupLog('✅ Raid Protection initialized');

      // Initialize Analytics
      startupLog('Initializing analytics service...');
      this.analytics = new AnalyticsService(this);
      startupLog('✅ Analytics Service initialized');

      // Initialize Auto-Moderation
      startupLog('Initializing auto-moderation service...');
      this.autoMod = new AutoModService(this);
      startupLog('✅ Auto-Moderation Service initialized');
